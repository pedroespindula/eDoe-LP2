...
class NecessitadoControllerTest {
  ...
  void listaTodosPorQuantidade() {
    var id3 = this.controller.cadastraItemPedido(new UsuarioTeste(1), "cadeira de rodas",
      11, "grande,adulta,primeira");
    var id1 = this.controller.cadastraItemPedido(new UsuarioTeste(1), "cadeira de rodas",
      9, "grande,adulta,ultima");
    var id2 = this.controller.cadastraItemPedido(new UsuarioTeste(1), "cadeira de rodas",
