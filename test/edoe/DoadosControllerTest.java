...
class DoadosControllerTest {
	...
	void testaItensParaDoacaoAlguns() {
		...
		assertEquals(doados.listaItensParaDoacao(), "bola de tenis, tags: [M, BL], quantidade: 5, doador: Teste/2 | camisa, tags: [M, BL], quantidade: 3, doador: Teste/1");
	}
	...
	void testaPesquisaItemParaDoacaoUnico() {
		...
		assertEquals(doados.pesquisaItemParaDoacaoPorDescricao("   CAM        "), "camisa, tags: [M, BL], quantidade: 10");
	}
	...
	void testaPesquisaItemParaDoacaoDois() {
		...
		this.doados.adicionaItemParaDoacao(new UsuarioTeste(1), "camisa", 3, "M, BL");
		assertEquals(doados.pesquisaItemParaDoacaoPorDescricao("      CaM      "), "camisa, tags: [M, BL], quantidade: 3 | camisola tags: [M, BL], quantidade: 1");
	}
